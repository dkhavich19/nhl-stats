...
while True:
    ...
    # print(scraper.all_players)
    # print(len(scraper.all_players))
    #print(list(scraper.players_id_name_dict.items()))
    # print(len(scraper.players_id_name_dict))
    ...
    if (user_option == '1'):
        ...
        # user_player_name = 'Alex Ovechkin'
        try:
            player_id = scraper.get_player_stats(user_player_name)
        except:
